...
//					Double.parseDouble("175.6"); 문자를 실수타입으로 변환.
				...
				if(keyword.equals("남") || keyword.equals("남자") || keyword.equals("men") || keyword.equals("m") || keyword.equals("a")) {
					gen = Gender.MALE;
				} else if (keyword.equals("여") || keyword.equals("여자") || keyword.equals("women") || keyword.equals("w") || keyword.equals("b")) {
					gen = Gender.FEMALE;
				}
